...
const WHATSAPP_API_URL = `https://graph.facebook.com/${process.env.REACT_APP_WHATSAPP_API_VERSION || 'v22.0'}`
const PHONE_NUMBER_ID = process.env.REACT_APP_WHATSAPP_PHONE_NUMBER_ID || '158282837372377'
