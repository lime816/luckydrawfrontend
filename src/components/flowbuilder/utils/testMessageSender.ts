...
export async function testSendMessage(recipientPhone: string): Promise<void> {
  ...
  console.log('🔑 Access Token:', process.env.REACT_APP_WHATSAPP_ACCESS_TOKEN ? 'Present' : 'Missing')
  console.log('📞 Phone Number ID:', process.env.REACT_APP_WHATSAPP_PHONE_NUMBER_ID)
  console.log('🌐 API Version:', process.env.REACT_APP_WHATSAPP_API_VERSION)
...
export function debugEnvironment(): void {
  ...
  console.log('- REACT_APP_WHATSAPP_ACCESS_TOKEN:', process.env.REACT_APP_WHATSAPP_ACCESS_TOKEN ? 'Set (length: ' + process.env.REACT_APP_WHATSAPP_ACCESS_TOKEN.length + ')' : 'Not set')
  console.log('- REACT_APP_WHATSAPP_PHONE_NUMBER_ID:', process.env.REACT_APP_WHATSAPP_PHONE_NUMBER_ID || 'Not set')
  console.log('- REACT_APP_WHATSAPP_BUSINESS_ACCOUNT_ID:', process.env.REACT_APP_WHATSAPP_BUSINESS_ACCOUNT_ID || 'Not set')
  console.log('- REACT_APP_WHATSAPP_API_VERSION:', process.env.REACT_APP_WHATSAPP_API_VERSION || 'Not set')
  console.log('- REACT_APP_WHATSAPP_BUSINESS_NUMBER:', process.env.REACT_APP_WHATSAPP_BUSINESS_NUMBER || 'Not set')
...
export async function testWhatsAppAPI(): Promise<void> {
  ...
  const API_VERSION = process.env.REACT_APP_WHATSAPP_API_VERSION || 'v22.0'
