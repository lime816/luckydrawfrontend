...
export const Contests: React.FC = () => {
  ...
  // Record who created this contest (id). Do NOT send the role string here;
  // the database trigger (or server) should populate `created_by_role` from the `admins` table.
